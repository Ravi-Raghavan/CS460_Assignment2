...
\begin{figure}[h!]
    ...
    \includegraphics[width=\linewidth]{arm_1.1-1.png}
    \caption{Provided environment}
  \end{minipage}\hfill
  \begin{minipage}{0.48\textwidth}
    \includegraphics[width=\linewidth]{arm_1.1-2.png}
...
\begin{figure}[htbp]
  ...
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\linewidth]{arm_1.2-1.png}
    \caption{target = [0,0], k=3}
  \end{minipage}\hfill
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\linewidth]{arm_1.2-2.png}
    \caption{target = [3.14,1.5], k=6}
  \end{minipage}
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\linewidth]{arm_1.2-3.png}
    \caption{target = [4,5.2], k=4}
  \end{minipage}\hfill
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\linewidth]{arm_1.2-4.png}
    \caption{target = [1.5,1.1], k=10}
  \end{minipage}
   \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\linewidth]{arm_1.2-5.png}
...
\begin{figure}[]
  \centering
    \includegraphics[width=\linewidth]{arm_1.2-ec10.png}
    \caption{Running time vs. number of nearest neighbors}
    \includegraphics[width=\linewidth]{arm_1.2-ec9.png}
...
\begin{figure}[htbp]
  \centering
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\linewidth]{arm_1.2-ec1.png}
    \caption{Search using 100 configurations}
  \end{minipage}\hfill
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\linewidth]{arm_1.2-ec2.png}
    \caption{Search using 500 configurations}
  \end{minipage}
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\linewidth]{arm_1.2-ec3.png}
    \caption{Search using 1000 configurations}
  \end{minipage}\hfill
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\linewidth]{arm_1.2-ec4.png}
...
\begin{figure}[htbp]
  \centering
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\linewidth]{arm_1.2-ec5.png}
    \caption{Search with k=3}
  \end{minipage}\hfill
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\linewidth]{arm_1.2-ec6.png}
    \caption{Search with k=5}
  \end{minipage}
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\linewidth]{arm_1.2-ec7.png}
    \caption{Search with k=10}
  \end{minipage}\hfill
  \begin{minipage}{0.45\textwidth}
    \includegraphics[width=\linewidth]{arm_1.2-ec8.png}
